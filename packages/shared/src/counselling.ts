...
import { COUNSELLING_V100_TO_V109 } from "./counsellingV100V109.js";
import { COUNSELLING_V110_TO_V119 } from "./counsellingV110V119.js";
import { COUNSELLING_V120_TO_V129 } from "./counsellingV120V129.js";
import { COUNSELLING_V130_TO_V139 } from "./counsellingV130V139.js";
import { COUNSELLING_V140_TO_V149 } from "./counsellingV140V149.js";
import { COUNSELLING_V150_TO_V159 } from "./counsellingV150V159.js";
import { COUNSELLING_V160_TO_V169 } from "./counsellingV160V169.js";
import { COUNSELLING_V170_TO_V179 } from "./counsellingV170V179.js";
import { COUNSELLING_V180_TO_V189 } from "./counsellingV180V189.js";
import { COUNSELLING_V190_TO_V199 } from "./counsellingV190V199.js";
import { COUNSELLING_V200_TO_V209 } from "./counsellingV200V209.js";
import { COUNSELLING_V210_TO_V219 } from "./counsellingV210V219.js";
import { COUNSELLING_V220_TO_V229 } from "./counsellingV220V229.js";
import { COUNSELLING_V230_TO_V239 } from "./counsellingV230V239.js";
import { COUNSELLING_V240_TO_V249 } from "./counsellingV240V249.js";
import { COUNSELLING_V250_TO_V259 } from "./counsellingV250V259.js";
import { COUNSELLING_V260_TO_V269 } from "./counsellingV260V269.js";
import { COUNSELLING_V270_TO_V279 } from "./counsellingV270V279.js";
import { COUNSELLING_V280_TO_V289 } from "./counsellingV280V289.js";
import { COUNSELLING_V290_TO_V299 } from "./counsellingV290V299.js";
import { COUNSELLING_V300_TO_V309 } from "./counsellingV300V309.js";
...
import { COUNSELLING_V345_TO_V356 } from "./counsellingV345V356.js";
import { COUNSELLING_V357_TO_V372 } from "./counsellingV357V372.js";
import { COUNSELLING_V373_TO_V384 } from "./counsellingV373V384.js";
import { COUNSELLING_V385_TO_V403 } from "./counsellingV385V403.js";
import { COUNSELLING_V404_TO_V415 } from "./counsellingV404V415.js";
import { COUNSELLING_V416_TO_V427 } from "./counsellingV416V427.js";
import { COUNSELLING_V428_TO_V439 } from "./counsellingV428V439.js";
import { COUNSELLING_V440_TO_V451 } from "./counsellingV440V451.js";
import { COUNSELLING_V452_TO_V463 } from "./counsellingV452V463.js";
...
const SCRIPTS: Record<string, Partial<Record<CounsellingLang, CounsellingScript>>> = {
  ...
  "mol-simvastatin": {
    en: {
      ...
      lines: [
        "Take this cholesterol medicine exactly as directed on your labelled product.",
        "Statin counselling commonly includes reporting unexplained muscle pain, tenderness, or weakness. Materia does not invent a dose or lipid target.",
        "Tell your pharmacist before starting new medicines — simvastatin has notable interaction potential; confirm against the labelled product. Materia does not invent an interaction list.",
        "If you get severe muscle pain with dark urine, yellowing of the skin/eyes, or trouble breathing — seek emergency care.",
      ],
    },
    zu: {
      ...
      lines: [
        "Sebenzisa lo muthi we-cholesterol njengoba kubhalwe kumkhiqizo onelebula.",
        "Ukwelulekwa kwe-statin kuvame ukufaka ukubika ubuhlungu bemisipha obungachaziwe, ukuthamba, noma ubuthakathaka. I-Materia ayiqambi umthamo noma umgomo we-lipid.",
        "Tshela umkhiqizi ngaphambi kokuqala imithi emisha — i-simvastatin inokuhlangana neminye; qinisekisa kumkhiqizo onelebula. I-Materia ayiqambi uhlu lokuhlangana.",
        "Uma uthola ubuhlungu bemisipha obukhulu nomchamo omnyama, ukuphaphatheka kwesikhumba/amehlo, noma ukuphefumula kanzima — funa usizo oluphuthumayo.",
      ],
    },
    af: {
      ...
      lines: [
        "Neem hierdie cholesterolmiddel soos op die geëtiketteerde produk aangedui.",
        "Statien-berading sluit dikwels in om onverklaarde spierpyn, teerheid of swakheid aan te meld. Materia versin nie ’n dosis of lipiedteiken nie.",
        "Sê vir jou apteker voordat jy nuwe medisyne begin — simvastatien het noemenswaardige wisselwerkingspotensiaal; bevestig teen die geëtiketteerde produk. Materia versin nie ’n wisselwerkingslys nie.",
        "As jy ernstige spierpyn met donker urine, vergeling van vel/oë, of asemhalingsprobleme kry — soek noodhulp.",
      ],
    },
    st: {
      ...
      lines: [
        "Sebelisa moriana ona oa cholesterol hantle kamoo e hlalositsoeng holabel ea sehlahiswa.",
        "Keletso ea statin hangata e kenyelletsa ho tlaleha bohloko ba mesifa bo sa hlaloseng, ho utloa bohloko, kapa bofokoli. Materia ha e iqape tekanyo kapa sepheo sa lipid.",
        "Bolella rakhemisi pele u qala meriana e mecha — simvastatin e na le monyetla oa ho kopana; netefatsa holabel. Materia ha e iqape lethathamo la ho kopana.",
        "Haeba u fumana bohloko ba mesifa bo tebileng ka moroto o lefifi, ho mosehla ha letlalo/mahlo, kapa ho hema thata — batla thuso ea tšohanyetso.",
      ],
    },
    xh: {
      ...
      lines: [
        "Sebenzisa eli yeza le-cholesterol ngokuchanekileyo njengoko kubhaliwe kwileyibhile yemveliso.",
        "Iingcebiso ze-statin zihlala zibandakanya ukuxela iintlungu zemisipha ezingachazwanga, ukuthamba, okanye ubuthathaka. I-Materia ayiyiqiqi idosi okanye usukelo lwe-lipid.",
        "Xelela usokhemisti phambi kokuqala amayeza amatsha — i-simvastatin inokudibana namanye; qinisekisa kwileyibhile. I-Materia ayiyiqiqi uluhlu lokudibana.",
        "Ukuba ufumana iintlungu zemisipha eziqatha nomchamo omnyama, ukutyheliwa kwesikhumba/amehlo, okanye uxinzelelo lokuphefumla — funa uncedo olungxamisekileyo.",
      ],
    },
  },
  ...
  "mol-losartan": {
    en: {
      ...
      lines: [
        "Take this blood-pressure medicine exactly as directed on your labelled product.",
        "ARB counselling commonly includes telling your pharmacist if you are pregnant, planning pregnancy, or breastfeeding — confirm against the labelled product. Materia does not invent a dose or blood-pressure target.",
    ...
    zu: {
      ...
      lines: [
        "Sebenzisa lo muthi womfutho wegazi njengoba kubhalwe kumkhiqizo onelebula.",
        "Ukwelulekwa kwe-ARB kuvame ukufaka ukutshela umkhiqizi uma ukhulelwe, uhlela ukukhulelwa, noma uncelisa — qinisekisa kumkhiqizo onelebula. I-Materia ayiqambi umthamo noma umgomo womfutho wegazi.",
        "Bika isiyezi uma umi noma izinkinga zezinso kumkhiqizi noma udokotela.",
        "Uma uthola ukuvuvuka kobuso, izindebe, ulimi, noma ukuphefumula kanzima — funa usizo oluphuthumayo.",
      ],
    },
    af: {
      ...
      lines: [
        "Neem hierdie bloeddrukmiddel soos op die geëtiketteerde produk aangedui.",
        "ARB-berading sluit dikwels in om jou apteker te sê as jy swanger is, beplan om swanger te word, of borsvoed — bevestig teen die geëtiketteerde produk. Materia versin nie ’n dosis of bloeddrukteiken nie.",
        "Meld duiseligheid wanneer jy opstaan of nierkommer by jou apteker of klinikus.",
        "As jy swelling van die gesig, lippe, tong of asemhalingsprobleme kry — soek noodhulp.",
      ],
    },
    st: {
      ...
      lines: [
        "Sebelisa moriana ona oa khatello ea mali hantle kamoo e hlalositsoeng holabel ea sehlahiswa.",
        "Keletso ea ARB hangata e kenyelletsa ho bolella rakhemisi haeba u imme, u rera ho ima, kapa u anyesa — netefatsa holabel. Materia ha e iqape tekanyo kapa sepheo sa khatello ea mali.",
        "Tlaleha ho tsekela ha u ema kapa mathata a liphio ho rakhemisi kapa ngaka.",
        "Haeba u fumana ho ruruha ha sefahleho, melomo, leleme, kapa ho hema thata — batla thuso ea tšohanyetso.",
      ],
    },
    xh: {
      ...
      lines: [
        "Sebenzisa eli yeza loxinzelelo lwegazi ngokuchanekileyo njengoko kubhaliwe kwileyibhile yemveliso.",
        "Iingcebiso ze-ARB zihlala zibandakanya ukuxelela usokhemisti ukuba ukhulelweyo, uceba ukukhulelwa, okanye uncancisayo — qinisekisa kwileyibhile. I-Materia ayiyiqiqi idosi okanye usukelo loxinzelelo lwegazi.",
        "Xela isiyezi xa umile okanye iinkxalabo zezintso kusokhemisti okanye ugqirha.",
        "Ukuba ufumana ukudumba kobuso, imilebe, ulwimi, okanye uxinzelelo lokuphefumla — funa uncedo olungxamisekileyo.",
      ],
    },
  },
  ...
  ...COUNSELLING_V100_TO_V109,
  ...COUNSELLING_V110_TO_V119,
  ...COUNSELLING_V120_TO_V129,
  ...COUNSELLING_V130_TO_V139,
  ...COUNSELLING_V140_TO_V149,
  ...COUNSELLING_V150_TO_V159,
  ...COUNSELLING_V160_TO_V169,
  ...COUNSELLING_V170_TO_V179,
  ...COUNSELLING_V180_TO_V189,
  ...COUNSELLING_V190_TO_V199,
  ...COUNSELLING_V200_TO_V209,
  ...COUNSELLING_V210_TO_V219,
  ...COUNSELLING_V220_TO_V229,
  ...COUNSELLING_V230_TO_V239,
  ...COUNSELLING_V240_TO_V249,
  ...COUNSELLING_V250_TO_V259,
  ...COUNSELLING_V260_TO_V269,
  ...COUNSELLING_V270_TO_V279,
  ...COUNSELLING_V280_TO_V289,
  ...COUNSELLING_V290_TO_V299,
  ...COUNSELLING_V300_TO_V309,
  ...COUNSELLING_V310_TO_V314,
  ...COUNSELLING_V315_TO_V321,
  ...COUNSELLING_V322_TO_V329,
  ...COUNSELLING_V330_TO_V344,
  ...COUNSELLING_V345_TO_V356,
  ...COUNSELLING_V357_TO_V372,
  ...COUNSELLING_V373_TO_V384,
  ...COUNSELLING_V385_TO_V403,
  ...COUNSELLING_V404_TO_V415,
  ...COUNSELLING_V416_TO_V427,
  ...COUNSELLING_V428_TO_V439,
  ...COUNSELLING_V440_TO_V451,
  ...COUNSELLING_V452_TO_V463,
};
